 ...
 * that the app serves offline. Run this by hand after a game patch to refresh:
 *
 *   npm run build-vocab
 *
 * This is the ONLY place that touches the network. The running app reads the
 * committed JSON — never UEX. Attribution: data © UEX Corp (uexcorp.space),
